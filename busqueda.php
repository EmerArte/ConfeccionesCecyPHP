      ...
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-md-9 order-2">
                ...
                <div class="d-flex">
                  <div class="dropdown mr-1 ml-md-auto">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                      <a class="dropdown-item" dropdown="Hombre" href="busqueda.php?idcategory=<?php echo "2";?>">Hombre</a>
                      <a class="dropdown-item" dropdown="Mujer" href="busqueda.php?idcategory=<?php echo "1";?>">Mujer</a>
                      <a class="dropdown-item" dropdown="Niño" href="busqueda.php?idcategory=<?php echo "3";?>">Niño</a>
                    </div>
                  </div>
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                      ...
                      <a class="dropdown-item" dropdown="ASC" href="busquedaordenada.php?idalfa=<?php echo "ASC";?>">Nombre, A a la Z</a>
                      <a class="dropdown-item" dropdown="DESC" href="busquedaordenada.php?idalfa=<?php echo "DESC";?>">Nombre, Z a la A</a>
            ...
            <?php
      include './php/conexion.php';
      $fres=$conexiones->query("select * from producto where id_categoria=".$_GET['idcategory'])or die($conexiones -> error);
      while ($resultadobus=mysqli_fetch_array($fres)){
            ?>
            ...
            <div class="border p-4 rounded mb-4">
              ...
              <div class="mb-4">
                ...
                <label for="s_md" class="d-flex">
                  <input type="checkbox" id="s_md" class="mr-2 mt-1"> <span class="text-black">M</span>
                </label>
