...
if(isset($_SESSION['carrito'])){
  ...
  if(isset($_GET['id'])){
    ...
    for($i=0; $i<count($vector);$i++){
      if($vector[$i]['Codigoc']==$_GET['id']){
        $encontro=true;
        $numero=$i;
      }
    }
    if($encontro==true){
      $vector[$numero]['Cantidad']=$vector[$numero]['Cantidad'];
      $_SESSION['carrito']=$vector;
    }else {
      //En caso de no encontrar registos
    $nombre="";
    $precio="";
    $cantidad="";
    $imagen="";
    $talla="";
    $res=$conexiones->query('select * from producto where CODIGOP='.$_GET['id'])or die($conexiones->error);
    ...
    array_push($vector, $vector2);
    $_SESSION['carrito']=$vector;
    }
  }
}else {
  //creamos variable e secion
  if(isset($_GET['id'])){
    $nombre="";
    $precio="";
    $cantidad="";
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="input-group mb-3" style="max-width: 120px;">
                        ...
                        data-id="<?php echo $arregloCarrito[$i]['Codigoc'];?>"
                    ...
                    <td class="cant<?php echo $arregloCarrito[$i]['Codigoc'];?>">$<?php echo $arregloCarrito[$i]['Precio'] * $arregloCarrito[$i]['Cantidad']; ?></td>
                    <td><a href="#" class="btn btn-primary btn-sm btnEliminar" data-id="<?php echo $arregloCarrito[$i]['Codigoc'];?>">X</a></td>
                  </tr>
                <?php
                }
              }
          ...
          <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <p>Digita tu cupon si tienes alguno.</p>
              </div>
              ...
              <div class="col-md-7">
                <div class="row">
                  <div class="col-md-12 text-right border-bottom mb-5">
                    <h3 class="text-black h4 text-uppercase">Tus Compras</h3>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-md-6">
